...
negdata = zeros(numcases,numdims);%same as data
...
for epoch = 1:maxepoch
    ...
    for batch = 1:numbatches
        ...
        %% go up
        ph = logistic(data*W + classes*Wc + repmat(b,numcases,1));%hidden nodes prob
		phstates = ph > rand(numcases,numhid);%hidden nodes 
